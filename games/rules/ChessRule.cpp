...
bool ChessRule::check(Position pos_start, Position pos_end, Board * board){
	bool ret = true;
...
bool ChessRule::checkPawn(Position pos_start, Position pos_end,Case case_piece, Board * board){
...
bool ChessRule::checkKnight(Position pos_start, Position pos_end, Case case_piece,Board * board){
...
bool ChessRule::checkRook(Position pos_start, Position pos_end,Case case_piece, Board * board){
	int i_end = Position::getMatrixNumber(pos_end.getRowPos());
	int j_end = Position::getMatrixNumber(pos_end.getColPos());
...
bool ChessRule::checkBishop(Position pos_start, Position pos_end, Case case_piece,Board * board){
	int i_end = Position::getMatrixNumber(pos_end.getRowPos());
	int j_end = Position::getMatrixNumber(pos_end.getColPos());
...
bool ChessRule::checkQueen(Position pos_start, Position pos_end, Case case_piece,Board * board){
...
bool ChessRule::checkKing(Position pos_start, Position pos_end, Case case_piece,Board * board){
	int i_end = Position::getMatrixNumber(pos_end.getRowPos());
	int j_end = Position::getMatrixNumber(pos_end.getColPos());
...
bool ChessRule::castling(string ins, string type_castling, string color_player , Board * board){
...
void ChessRule::doIfEnPassant(string colorPlayer,string pos_start, string pos_end, Game * game,Board * board){
...
void ChessRule::doIfPromotePawn(string colorPlayer,string pos_start, string pos_end, Game * game,Board * board){
	int col_start = Position::getMatrixNumber(pos_start[0]);
	int row_start = Position::getMatrixNumber(pos_start[1]);
	...
	Case c_end = board->getCase(row_end,col_end);
		if(colorPlayer == WHITE && c_end.getPiece()->getName() == "Pawn"){
			if(i_end == 0 && i_start == 1 ){
				Case * c = new Case();
				c->setColor(WHITE);
				cout<<"congratulations for the promotion which one you choose :"<<endl;
				cout<<"1 Knight"<<endl;
				cout<<"2 bishop"<<endl;
				cout<<"3 Rook"<<endl;
				cout<<"4 Queen ;)"<<endl;
...
void ChessRule::markEnPassant(string colorPlayer,string pos_start, string pos_end, Game * game,Board * board){
	int col_start = Position::getMatrixNumber(pos_start[0]);
	int row_start = Position::getMatrixNumber(pos_start[1]);
...
bool ChessRule::checkAll(string colorPlayer,string pos_start, string pos_end, Game * game,Board * board){
